      ...
      <form action="register" method="post" class="register-form"
        ...
        <div class="input-div one">
          ...
          <div>
            ...
            <input class="input" type="password" name="re_pass" id="re_pass">
          </div>
        </div>
        <div class="input-div two">
          <div class="i">
          ...
          <div>
            <h5>Role</h5>
            <input class="input" type="text" name="role" id="role">
          </div>
        </div>
        <div class="terms">
          <input type="checkbox">
          <label>I have read and agree to the </label><a id="action-modal">terms of use.</a>
        </div>
        <div class="btn-container">
          <a href="login.jsp" class="btn-action" name="signup">Sign Up</a>
        </div>
        <div class="account">
